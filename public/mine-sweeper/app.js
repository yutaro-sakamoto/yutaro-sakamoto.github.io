...
(function($PS) {
  ...
  var CellOpen = (function () {
      function CellOpen() {

      };
      CellOpen.value = new CellOpen();
      return CellOpen;
  })();
  var CellClose = (function () {
      function CellClose(value0) {
          this.value0 = value0;
      };
      CellClose.create = function (value0) {
          return new CellClose(value0);
      };
      return CellClose;
  })();
  var CellLeftClick = (function () {
      function CellLeftClick(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CellLeftClick.create = function (value0) {
          return function (value1) {
              return new CellLeftClick(value0, value1);
          };
      };
      return CellLeftClick;
  })();
  var CellRightClick = (function () {
      function CellRightClick(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      CellRightClick.create = function (value0) {
          return function (value1) {
              return new CellRightClick(value0, value1);
          };
      };
  ...
  var setCellAppearance = function (appearance) {
      return function (cell) {
          return {
              appearance: appearance,
              arroundBombs: cell.arroundBombs,
  ...
  var onContextMenu = Halogen_HTML_Events.handler("contextmenu");
  var modifyBoardAt = function (x) {
      return function (y) {
          return function (board) {
              return function (f) {
                  return Data_Maybe.fromMaybe(board)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(board)(x))(function (line) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.modifyAt(y)(f)(line))(function (newLine) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.updateAt(x)(newLine)(board))(function (newBoard) {
                              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(newBoard);
                          });
                      });
                  }));
              };
  ...
  var modifyBoardAtPoints = function (modifyCell) {
      return function (board) {
          return function (points) {
              var f = function (bd) {
                  return function (point) {
                      return modifyBoardAt(Data_Tuple.fst(point))(Data_Tuple.snd(point))(bd)(modifyCell);
                  };
              };
              return Data_Array.foldl(f)(board)(points);
          };
      };
  };
  var modifyBoardAtAll = function (modifyCell) {
      return function (board) {
          var ylen = Data_Array.length(Data_Maybe.fromMaybe([  ])(Data_Array.index(board)(0)));
          var xlen = Data_Array.length(board);
          var points = Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(xlen - 1 | 0))(function (x) {
              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(ylen - 1 | 0))(function (y) {
                  return Control_Applicative.pure(Control_Applicative.applicativeArray)(new Data_Tuple.Tuple(x, y));
              });
          });
          return modifyBoardAtPoints(modifyCell)(board)(points);
      };
  };
  var isClosedCell = function (cell) {
      if (cell.appearance instanceof CellClose) {
          return true;
      };
      return false;
  };
  var numberOfClosedCells = (function () {
      var $94 = Data_Foldable.sum(Data_Foldable.foldableArray)(Data_Semiring.semiringInt);
      var $95 = Data_Functor.map(Data_Functor.functorArray)((function () {
          var $97 = Data_Array.filter(isClosedCell);
          return function ($98) {
              return Data_Array.length($97($98));
          };
      })());
      return function ($96) {
          return $94($95($96));
  ...
  var initialCell = function (x) {
      return function (y) {
          return {
              appearance: new CellClose(false),
              arroundBombs: 0,
              hasBomb: false,
              x: x,
              y: y
  ...
  var makeInitialBoard = function (config) {
      return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(config.boardHeight - 1 | 0))(function (x) {
          return Control_Applicative.pure(Control_Applicative.applicativeArray)(Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(0)(config.boardWidth - 1 | 0))(function (y) {
              return Control_Applicative.pure(Control_Applicative.applicativeArray)(initialCell(x)(y));
          }));
      });
  };
  var getBoardAt = function (x) {
      return function (y) {
          return function (board) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(board)(x))(function (line) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(line)(y))(function (cell) {
  ...
  var getArroundPoints = function (x) {
      return function (y) {
          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(-1 | 0)(1))(function (dx) {
              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(-1 | 0)(1))(function (dy) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Bind.bindArray)(Control_Alternative.guard(Control_Alternative.alternativeArray)(dx !== 0 || dy !== 0))(function () {
                      return Control_Applicative.pure(Control_Applicative.applicativeArray)(new Data_Tuple.Tuple(x + dx | 0, y + dy | 0));
                  });
              });
          });
      };
  };
  var generateRandomArray = function (v) {
      return function (v1) {
          if (v1.length === 0) {
              return Control_Applicative.pure(Effect.applicativeEffect)([  ]);
          };
          ...
          return function __do() {
              var index = Effect_Random.randomInt(0)(Data_Array.length(v1) - 1 | 0)();
              var ys = Data_Maybe.fromMaybe([  ])(Data_Array.deleteAt(index)(v1));
              var y = Data_Maybe.fromMaybe(0)(Data_Array.index(v1)(index));
              return Data_Functor.map(Effect.functorEffect)(Data_Array.cons(y))(generateRandomArray(v - 1 | 0)(ys))();
          };
      };
  };
  var spreadBombs = function (config) {
      return function (x) {
          return function (y) {
              return function (board) {
                  var putBomb = function (bd) {
                      return function (n) {
                          var y_ = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n)(config.boardWidth);
                          var x_ = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(n)(config.boardWidth);
                          return modifyBoardAt(x_)(y_)(bd)(function (cell) {
                              return {
                  ...
                  var n = (x * config.boardWidth | 0) + y | 0;
                  var farFromN = function (m) {
                      var my = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(m)(config.boardWidth);
                      var mx = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(m)(config.boardWidth);
                      return Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(mx - x | 0) > 1 || Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(my - y | 0) > 1;
                  };
                  var indices = Data_Array.filter(farFromN)(Data_Array.range(0)((config.boardWidth * config.boardHeight | 0) - 1 | 0));
                  return function __do() {
                      var ys = generateRandomArray(config.numberOfBombs)(indices)();
                      return Data_Array.foldl(putBomb)(board)(ys);
                  };
              };
          };
      };
  };
  var filterPointsOnBoard = function (pred) {
      return function (board) {
          return function (points) {
              var f = function (v) {
                  var v1 = getBoardAt(v.value0)(v.value1)(board);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return false;
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return pred(v1.value0);
                  };
                  throw new Error("Failed pattern match at Main (line 368, column 21 - line 370, column 29): " + [ v1.constructor.name ]);
              };
              return Data_Array.filter(f)(points);
          };
      };
  };
  var openAllClosedNoFlagCellsArround = function (x) {
      return function (y) {
          return function (state) {
              var noFlagClosePoint = function (cell) {
                  if (cell.appearance instanceof CellClose && !cell.appearance.value0) {
                      return true;
                  };
                  return false;
              };
              var arroundPoints = getArroundPoints(x)(y);
              var pointsToOpen = filterPointsOnBoard(noFlagClosePoint)(state.board)(arroundPoints);
              var bombPoints = filterPointsOnBoard(function (v) {
                  return v.hasBomb;
              })(state.board)(pointsToOpen);
              var newBoard = modifyBoardAtPoints(setCellAppearance(CellOpen.value))(state.board)(pointsToOpen);
              var $43 = Data_Array["null"](bombPoints);
              if ($43) {
                  return {
                      config: state.config,
                      board: newBoard,
  ...
  var openArroundCells = function ($copy_marked) {
      return function ($copy_zeroCells) {
          return function ($copy_board) {
              var $tco_var_marked = $copy_marked;
              var $tco_var_zeroCells = $copy_zeroCells;
              var $tco_done = false;
              var $tco_result;
              function $tco_loop(marked, zeroCells, board) {
                  var v = Data_Array.uncons(zeroCells);
                  if (v instanceof Data_Maybe.Nothing) {
                      $tco_done = true;
                      return marked;
                  };
                  if (v instanceof Data_Maybe.Just) {
                      var arroundPoints = getArroundPoints(v.value0.head.value0)(v.value0.head.value1);
                      var safePoints = filterPointsOnBoard(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(function (v1) {
                          return v1.hasBomb;
                      }))(board)(arroundPoints);
                      var zeroPoints = filterPointsOnBoard(function (cell) {
                          return cell.arroundBombs === 0;
                      })(board)(safePoints);
                      $tco_var_marked = Data_Semigroup.append(Data_Semigroup.semigroupArray)(marked)(Data_Array.difference(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(safePoints)(marked));
                      $tco_var_zeroCells = Data_Semigroup.append(Data_Semigroup.semigroupArray)(v.value0.tail)(Data_Array.difference(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(Data_Array.difference(Data_Tuple.eqTuple(Data_Eq.eqInt)(Data_Eq.eqInt))(zeroPoints)(marked))(v.value0.tail));
                      $copy_board = board;
                      return;
                  };
                  throw new Error("Failed pattern match at Main (line 276, column 3 - line 284, column 109): " + [ v.constructor.name ]);
              };
              while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_marked, $tco_var_zeroCells, $copy_board);
              };
              return $tco_result;
          };
      };
  };
  var openCells = function (x) {
      return function (y) {
          return function (board) {
              var v = getBoardAt(x)(y)(board);
              if (v instanceof Data_Maybe.Nothing) {
                  return board;
              };
              if (v instanceof Data_Maybe.Just) {
                  if (v.value0.hasBomb) {
                      return modifyBoardAt(x)(y)(board)(setCellAppearance(CellOpen.value));
                  };
                  var zeroCells = (function () {
                      var $52 = v.value0.arroundBombs === 0;
                      if ($52) {
                          return [ new Data_Tuple.Tuple(x, y) ];
                      };
                      return [  ];
                  })();
                  var pointsToOpen = openArroundCells([ new Data_Tuple.Tuple(x, y) ])(zeroCells)(board);
                  return modifyBoardAtPoints(setCellAppearance(CellOpen.value))(board)(pointsToOpen);
              };
              throw new Error("Failed pattern match at Main (line 259, column 3 - line 272, column 80): " + [ v.constructor.name ]);
          };
      };
  };
  var openArroundCellsAtOnce = function (x) {
      return function (y) {
          return function (state) {
              var v = getBoardAt(x)(y)(state.board);
              if (v instanceof Data_Maybe.Nothing) {
                  return state;
              };
              if (v instanceof Data_Maybe.Just) {
                  if (v.value0.appearance instanceof CellClose) {
                      return state;
                  };
                  if (v.value0.appearance instanceof CellOpen) {
                      var isFlagCell = function (c) {
                          if (c.appearance instanceof CellClose && c.appearance.value0) {
                              return true;
                          };
                          return false;
                      };
                      var arroundPoints = getArroundPoints(x)(y);
                      var numberOfFlagsArround = Data_Array.length(filterPointsOnBoard(isFlagCell)(state.board)(arroundPoints));
                      var $59 = v.value0.arroundBombs === numberOfFlagsArround;
                      if ($59) {
                          return openAllClosedNoFlagCellsArround(x)(y)(state);
                      };
                      return state;
                  };
                  throw new Error("Failed pattern match at Main (line 228, column 5 - line 240, column 23): " + [ v.value0.appearance.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 225, column 36 - line 240, column 23): " + [ v.constructor.name ]);
          };
      };
  };
  var setArroundBombNumbers = function (board) {
      var setNumber = function (cell) {
          var arroundPoints = getArroundPoints(cell.x)(cell.y);
          var pointsHasBomb = filterPointsOnBoard(function (v) {
              return v.hasBomb;
          })(board)(arroundPoints);
          return {
              appearance: cell.appearance,
              arroundBombs: Data_Array.length(pointsHasBomb),
              hasBomb: cell.hasBomb,
              x: cell.x,
              y: cell.y
          };
      };
      return modifyBoardAtAll(setNumber)(board);
  };
  var defaultConfig = {
      boardWidth: 10,
      boardHeight: 20,
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          if (v instanceof CellLeftClick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (state.phase instanceof Playing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                              var v1 = getBoardAt(v.value0)(v.value1)(state.board);
                              if (v1 instanceof Data_Maybe.Nothing) {
                                  return state;
                              };
                              if (v1 instanceof Data_Maybe.Just) {
                                  if (v1.value0.hasBomb) {
                                      return {
                                          board: openCells(v.value0)(v.value1)(state.board),
                                          phase: GameOver.value,
                                          config: state.config,
                                          ranking: state.ranking
                                      };
                                  ...
                                  var state_ = (function () {
                                      if (v1.value0.appearance instanceof CellOpen) {
                                          return openArroundCellsAtOnce(v.value0)(v.value1)(state);
                                      };
                                      return {
                                          board: openCells(v.value0)(v.value1)(state.board),
                                          config: state.config,
                                  ...
                                  var $66 = numberOfClosedCells(state_.board) === state_.config.numberOfBombs;
                                  if ($66) {
                                      return {
                                          phase: Clear.value,
                                          board: state_.board,
                                          config: state_.config,
                                          ranking: state_.ranking
                                      };
                                  };
                                  return state_;
                              };
                              throw new Error("Failed pattern match at Main (line 178, column 11 - line 189, column 35): " + [ v1.constructor.name ]);
                          })());
                      };
                      if (state.phase instanceof Ready) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(spreadBombs(state.config)(v.value0)(v.value1)(state.board)))(function (boardWithBombs) {
                              var newBoard = setArroundBombNumbers(boardWithBombs);
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)({
                                  board: openCells(v.value0)(v.value1)(newBoard),
                                  phase: Playing.value,
                                  config: state.config,
                                  ranking: state.ranking
                              });
                      ...
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(state);
                  })())(function (newState) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(newState);
                  });
              });
          };
          if (v instanceof CellRightClick) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      if (v1.value0.appearance instanceof CellClose) {
                          var $72 = {};
                          for (var $73 in state) {
                          ...
                          $72.board = modifyBoardAt(v.value0)(v.value1)(state.board)(setCellAppearance(CellClose.create(!v1.value0.appearance.value0)));
                          return $72;
                      };
                      return state;
                  };
                  throw new Error("Failed pattern match at Main (line 200, column 8 - line 204, column 22): " + [ v1.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Main (line 170, column 16 - line 212, column 9): " + [ v.constructor.name ]);
      };
  };
  ...
  var cellDesignClass = function (cell) {
      return Data_Functor.map(Data_Functor.functorArray)(Web_HTML_Common.ClassName)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "cell" ])((function () {
          if (cell.appearance instanceof CellOpen) {
              return [ "cell-open", "cell-open-" + Data_Show.show(Data_Show.showInt)(cell.arroundBombs) ];
          };
          if (cell.appearance instanceof CellClose) {
              if (cell.appearance.value0) {
                  return [ "cell-close", "cell-flag" ];
              };
              return [ "cell-close" ];
          };
          throw new Error("Failed pattern match at Main (line 163, column 3 - line 167, column 44): " + [ cell.appearance.constructor.name ]);
      })()));
  };
      ...
      return function (x) {
          return function (y) {
              return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
                  return new CellLeftClick(x, y);
              }), onContextMenu(function (v) {
                  return new CellRightClick(x, y);
              }), Halogen_HTML_Properties.classes(cellDesignClass(cell)) ])([ Halogen_HTML_Core.text((function () {
                  if (cell.appearance instanceof CellClose) {
                      if (cell.appearance.value0) {
                          return "@";
                      };
                  ...
                  if (cell.appearance instanceof CellOpen) {
                      ...
                      var $86 = cell.arroundBombs === 0;
                      if ($86) {
                          return "-";
                      };
                      return Data_Show.show(Data_Show.showInt)(cell.arroundBombs);
                  };
                  throw new Error("Failed pattern match at Main (line 151, column 3 - line 158, column 45): " + [ cell.appearance.constructor.name ]);
              })()) ]);
          };
      };
  };
  var renderBoard = function (board) {
      return Halogen_HTML_Elements.div_(Control_Bind.bind(Control_Bind.bindArray)(Data_Array.zip(board)(Data_Array.range(0)(Data_Array.length(board) - 1 | 0)))(function (v) {
          return Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.div_(Control_Bind.bind(Control_Bind.bindArray)(Data_Array.zip(v.value0)(Data_Array.range(0)(Data_Array.length(v.value0) - 1 | 0)))(function (v1) {
              return Control_Applicative.pure(Control_Applicative.applicativeArray)(renderCell(v1.value0)(v.value1)(v1.value1));
          })));
      }));
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Mine Sweeper") ]), Halogen_HTML_Elements.div_([ renderBoard(state.board) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text((function () {
          if (state.phase instanceof Ready) {
              return "";
          };
          if (state.phase instanceof Playing) {
          ...
          if (state.phase instanceof GameOver) {
              return "Game Over";
          };
          if (state.phase instanceof Clear) {
              return "Game Clear!!";
          };
          throw new Error("Failed pattern match at Main (line 120, column 20 - line 124, column 36): " + [ state.phase.constructor.name ]);
      })()) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return Reset.value;
  ...
  exports["main"] = main;
  exports["CellOpen"] = CellOpen;
  exports["CellClose"] = CellClose;
  exports["Ready"] = Ready;
  ...
  exports["initialCell"] = initialCell;
  exports["CellLeftClick"] = CellLeftClick;
  exports["CellRightClick"] = CellRightClick;
  exports["Reset"] = Reset;
  ...
  exports["cellDesignClass"] = cellDesignClass;
  exports["handleAction"] = handleAction;
  exports["numberOfClosedCells"] = numberOfClosedCells;
  exports["isClosedCell"] = isClosedCell;
  exports["openArroundCellsAtOnce"] = openArroundCellsAtOnce;
  exports["openAllClosedNoFlagCellsArround"] = openAllClosedNoFlagCellsArround;
  exports["openCells"] = openCells;
  exports["openArroundCells"] = openArroundCells;
  exports["generateRandomArray"] = generateRandomArray;
  exports["spreadBombs"] = spreadBombs;
  exports["setArroundBombNumbers"] = setArroundBombNumbers;
  exports["modifyBoardAt"] = modifyBoardAt;
  exports["modifyBoardAtPoints"] = modifyBoardAtPoints;
  exports["modifyBoardAtAll"] = modifyBoardAtAll;
  exports["getBoardAt"] = getBoardAt;
  exports["getArroundPoints"] = getArroundPoints;
  exports["filterPointsOnBoard"] = filterPointsOnBoard;
  exports["setCellAppearance"] = setCellAppearance;
})(PS);
PS["Main"].main();